...
\begin{textbox}{(in-class) DP Examples}
    \begin{itemize}
        \item String Reconstruction(\href{https://leetcode.com/problems/word-break/)}{Word Break} 
        \item \href{https://leetcode.com/problems/longest-increasing-subsequence/}{LongestIncrSubsequence (LIS)} 
        \item \href{https://leetcode.com/problems/number-of-longest-increasing-subsequence/}{Number of LISs}
        \item Context-free grammar parsing $O(n^3m^2)$
        \item Knapsack Problem $O(n\cdot|capacity|)$ NP 
